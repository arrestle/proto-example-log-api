...
// 	protoc        v5.26.0
// source: third_party/opentelemetry-proto/opentelemetry/proto/logs/v1/logs.proto
...
func (SeverityNumber) Descriptor() protoreflect.EnumDescriptor {
	return file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_enumTypes[0].Descriptor()
}

func (SeverityNumber) Type() protoreflect.EnumType {
	return &file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_enumTypes[0]
}
...
func (SeverityNumber) EnumDescriptor() ([]byte, []int) {
	return file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_rawDescGZIP(), []int{0}
}
...
func (LogRecordFlags) Descriptor() protoreflect.EnumDescriptor {
	return file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_enumTypes[1].Descriptor()
}

func (LogRecordFlags) Type() protoreflect.EnumType {
	return &file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_enumTypes[1]
}
...
func (LogRecordFlags) EnumDescriptor() ([]byte, []int) {
	return file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_rawDescGZIP(), []int{1}
}
...
func (x *LogsData) Reset() {
	*x = LogsData{}
	mi := &file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_msgTypes[0]
...
func (x *ResourceLogs) Reset() {
	*x = ResourceLogs{}
	mi := &file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ScopeLogs) Reset() {
	*x = ScopeLogs{}
	mi := &file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScopeLogs) Descriptor() ([]byte, []int) {
	return file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_rawDescGZIP(), []int{2}
}
...
func (x *LogRecord) Reset() {
	*x = LogRecord{}
	mi := &file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LogRecord) Descriptor() ([]byte, []int) {
	return file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_rawDescGZIP(), []int{3}
}
...
var File_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto protoreflect.FileDescriptor

const file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_rawDesc = "" +
	"\n" +
	"Fthird_party/opentelemetry-proto/opentelemetry/proto/logs/v1/logs.proto\x12\x1bopentelemetry.proto.logs.v1\x1a*opentelemetry/proto/common/v1/common.proto\x1a.opentelemetry/proto/resource/v1/resource.proto\"Z\n" +
	"\bLogsData\x12N\n" +
...
var (
	file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_rawDescOnce sync.Once
	file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_rawDescData []byte
)

func file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_rawDescGZIP() []byte {
	file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_rawDescOnce.Do(func() {
		file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_rawDesc), len(file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_rawDesc)))
	})
	return file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_rawDescData
}

var file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_goTypes = []any{
...
var file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_depIdxs = []int32{
...
func init() { file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_init() }
func file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_init() {
	if File_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_rawDesc), len(file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_goTypes,
		DependencyIndexes: file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_depIdxs,
		EnumInfos:         file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_enumTypes,
		MessageInfos:      file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_msgTypes,
	}.Build()
	File_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto = out.File
	file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_goTypes = nil
	file_third_party_opentelemetry_proto_opentelemetry_proto_logs_v1_logs_proto_depIdxs = nil
}
